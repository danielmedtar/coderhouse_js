...
const KEY = 'Y8LpfAGP17fXcDGBYzNR6VJnNllVeH9x'
    ...
    const llamarApi = (busqueda) => {
        ...
        $.get(`https://api.giphy.com/v1/gifs/search?api_key=${KEY}&q=${encodeURI(busqueda)}&limit=6`, function(response){ //ENCODE URI SIRVE PARA ELIMINAR LOS ESPACIOS (DE TENER) CUANDO UN USUARIO HACE UNA BUSQUEDA

        $('.contenedor-gif').html('')

         response.data.forEach(element => {
        
        $('.contenedor-gif').append(`    
